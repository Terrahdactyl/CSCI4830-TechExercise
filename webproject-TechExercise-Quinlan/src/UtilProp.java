...
public class UtilProp {
   ...
   static String _PROP_FILENAME_WIN_LOCAL = "C:\\Users\\Terrah\\Documents\\UNO\\workspace4830\\webproject-TechExercise-Quinlan\\WebContent\\config.properties";
   static String _PROP_FILENAME_OSX_LOCAL = "/YOUR_PATH/webproject/WebContent/config.properties";
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat7/webapps/webproject/config.properties"; //TODO: check this?
